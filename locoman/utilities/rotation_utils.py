...
# def rot_mat_to_rpy(R):
#     return p3dt.matrix_to_euler_angles(R, convention="ZYX")

# def rpy_to_rot_mat(rpy):
#     return p3dt.euler_angles_to_matrix(rpy, convention="ZYX")

# def rot_mat_to_quat(R):
#     return p3dt.matrix_to_quaternion(R)

# def quat_to_rot_mat(q):
#     return p3dt.quaternion_to_matrix(q)

# def rpy_to_quat(rpy):
#     return p3dt.euler_angles_to_quaternion(rpy, convention="ZYX")

# def quat_to_rpy(q):
#     return p3dt.quaternion_to_euler_angles(q, convention="ZYX")
