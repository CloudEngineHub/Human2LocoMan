...
# def rot_mat_to_rpy(R):
#     return scipyR.from_matrix(R).as_euler('zyx', degrees=False)

# def rpy_to_rot_mat(rpy):
#     return scipyR.from_euler('zyx', rpy, degrees=False).as_matrix()

# def quat_to_rpy(q):
#     return scipyR.from_quat(q).as_euler('zyx', degrees=False)

# def rpy_to_quat(rpy):
#     return scipyR.from_euler('zyx', rpy, degrees=False).as_quat()
...
if __name__ == '__main__':
    print(rpy_to_quat(np.array([0,0,0.3])))
