...
class MotorGroup:
  ...
  def __init__(self,
    ...
    # self._contact_state = torch.ones(4, dtype=torch.bool, device=device, requires_grad=False)
    ...
    # print('motor_kp', self._kps)
    # print('motor_kd', self._kds)
    # print('motor_kp_stance', self._kps_stance)
    # print('motor_kd_stance', self._kds_stance)
    # print('motor_kp_swing', self._kps_swing)
    # print('motor_kd_swing', self._kds_swing)
  ...
  # def set_contact_state(self, value: _ARRAY):
  #   self._contact_state = torch.tensor(value, dtype=torch.bool, device=self._device, requires_grad=False)

  # @property
  # def locomani_kps(self):
  #   locomani_kps = self._kps.clone().reshape(4, 3)
  #   locomani_kps[self.contact_state] = self._kps_stance.view(4, 3)[self.contact_state]
  #   locomani_kps[~self.contact_state] = self._kps_swing.view(4, 3)[~self.contact_state]
  #   return locomani_kps.reshape(-1)
  
  # @property
  # def locomani_kds(self):
  #   locomani_kds = self._kds.clone().reshape(4, 3)
  #   locomani_kds[self.contact_state] = self._kds_stance.view(4, 3)[self.contact_state]
  #   locomani_kds[~self.contact_state] = self._kds_swing.view(4, 3)[~self.contact_state]
  #   return locomani_kds.reshape(-1)
