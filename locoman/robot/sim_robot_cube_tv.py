...
class SimRobot(BaseRobot):
    ...
    def _create_envs(self):
        ...
        # self.tele_vision = OpenTeleVision((int(self.fpv_height), self.fpv_width))
        ...
        for i in range(self._num_envs):
            ...
            local_transform.p = gymapi.Vec3(0.15, 0.0, 0.45)
    ...
    def step(self, action: MotorCommand, motor_control_mode: MotorControlMode = None, gripper_cmd=True, show_img=True):
        ...
        # self.tele_vision.modify_shared_image(rgb_image)
